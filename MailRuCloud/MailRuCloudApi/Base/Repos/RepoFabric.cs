...
namespace YaR.Clouds.Base.Repos
{
    public class RepoFabric
    {
        ...
        public IRequestRepo Create()
        {
            ...
            {
                Protocol.YadWebV2 => new YandexDisk.YadWebV2.YadWebRequestRepo( _settings.Proxy, _credentials ),
                Protocol.YadWeb => new YandexDisk.YadWeb.YadWebRequestRepo(_settings.Proxy, _credentials),
