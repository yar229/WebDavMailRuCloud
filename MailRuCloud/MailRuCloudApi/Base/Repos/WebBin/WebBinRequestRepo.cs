...
using YaR.MailRuCloud.Api.Base.Repos.WebM1;
using YaR.MailRuCloud.Api.Base.Repos.WebM1.Requests;
...
using AccountInfoRequest = YaR.MailRuCloud.Api.Base.Repos.WebM1.Requests.AccountInfoRequest;
using CreateFolderRequest = YaR.MailRuCloud.Api.Base.Repos.Mobile.Requests.CreateFolderRequest;
using MoveRequest = YaR.MailRuCloud.Api.Base.Repos.Mobile.Requests.MoveRequest;

namespace YaR.MailRuCloud.Api.Base.Repos.WebBin
{
    /// <summary>
    /// Combination of WebM1 and Mobile protocols
    /// </summary>
    class WebBinRequestRepo : IRequestRepo
    {
