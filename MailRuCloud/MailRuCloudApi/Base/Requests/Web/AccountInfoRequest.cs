...
namespace YaR.MailRuCloud.Api.Base.Requests.Web
{
    class AccountInfoRequest : BaseRequestJson<AccountInfoRequest.Result>
    {
        ...
        public AccountInfoRequest(CloudApi cloudApi, string token) : base(cloudApi)
        {
            _token = token;
        }

        protected override string RelationalUri => $"{ConstSettings.CloudDomain}/api/v2/user?token={_token}";
