...
```diff
Этот fork оригинального проекта сделан для входа на Яндекс.Диск
с помощью браузера и для поддержки всего разнообразия вариантов
аутентификации, включая коды СМС и QR-коды.
Версия .NET обновлена до 7.0, включая поддержку Windows service.
```
Оригинальный проект находится по адресу
[https://github.com/yar229/WebDavMailRuCloud](https://github.com/yar229/WebDavMailRuCloud).
